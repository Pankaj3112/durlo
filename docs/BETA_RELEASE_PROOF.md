...
mutations, the full deterministic suite, the packed quickstart, restricted-role behavior, seeded
stress, and persistence-safety mutations. The database-backed portion creates and removes a
disposable PostgreSQL 17 container. It does not require or mutate a developer database.
...
observe deployments, retries, cancellation, and recovery. Repository tests, examples, and soak
